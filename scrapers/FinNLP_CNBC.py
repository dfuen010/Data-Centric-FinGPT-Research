...
news_downloader.download_streaming_search(keyword = "Q1 Earning", rounds = 3)

# Print the first 5 rows of the dataframe
print(news_downloader.dataframe.head())

# Save the dataframe to a csv file
news_downloader.dataframe.to_csv(r'C:\Users\jc219\OneDrive\Desktop\GitHub\Data-Centric-FinGPT-Research\scrapers\q1_earnings.csv', index = False)